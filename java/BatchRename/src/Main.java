...
public class Main 
{
	...
	{
		BatchRenameFrame frame = new BatchRenameFrame();
		//使用一个皮肤
		try 
		{
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable(){
			public void run()
			{
				...
				frame.setLocation(screenSize.width / 2 - frame.getWidth(),
					screenSize.height / 2 - frame.getHeight());
			}
		});
	}
}
