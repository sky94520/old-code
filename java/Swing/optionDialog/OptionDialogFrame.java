...
public class OptionDialogFrame extends JFrame
{
	...
	public OptionDialogFrame()
	{
		...
		optionTypePanel=new ButtonPanel("Confirm","DEFAULT_OPTION","YES_NO_OPTION","YES_NO_CANEL_OPTION","OK_CANEL_OPTION");
	...
	public Object[] getOptions()
	{
		...
		if(s.equals("String[]")) return new String[]{"Yellow","Button","Red"};
...
class SampleComponent extends JComponent
{
	public void actionPerformed(Graphics g)
	{
		...
		Rectangle2D rect=new Rectangle.Double(0,0,getWidth()-1,getHeight()-1);
