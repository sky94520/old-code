...
LOCAL_SRC_FILES := $(subst $(LOCAL_PATH)/,, $(wildcard $(LOCAL_PATH)/SDL_Engine/*.cpp))\
				   ...
				   $(subst $(LOCAL_PATH)/,,$(wildcard $(LOCAL_PATH)/SDL_Engine/physics/*.cpp))\
				   $(subst $(LOCAL_PATH)/,,$(wildcard $(LOCAL_PATH)/SDL_Engine/extensions/*.cpp))\
				   $(subst $(LOCAL_PATH)/,, $(wildcard $(LOCAL_PATH)/SDL_Engine/*.c))
LOCAL_CPPFLAGS += -std=c++11 -frtti -pthread
